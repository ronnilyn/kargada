            ...
            <div class="bottom-data">
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php $sql = "SELECT * FROM fms_g17_shipment_details WHERE status = 5";
                            $stmt = $this->conn()->query($sql);
                            while ($row = $stmt->fetch()) { ?>
                               <tr>
                                    ...
                                    <td><a class="btn button" href="view_details.php?reference_code=<?php echo $row['reference_code'] ?>"><i class="fa fa-eye"></i> View</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
